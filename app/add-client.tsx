      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.keyboardView}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.typeSelector}>
            <TouchableOpacity 
              style={[styles.typeOption, { borderColor: theme.border }, type === 'individual' && { backgroundColor: theme.primary, borderColor: theme.primary }]}
            ...
            <TouchableOpacity 
              style={[styles.typeOption, { borderColor: theme.border }, type === 'company' && { backgroundColor: theme.primary, borderColor: theme.primary }]}
...
const styles = StyleSheet.create({
  ...
  typeOption: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 12, borderRadius: 12, borderWidth: 1 },
