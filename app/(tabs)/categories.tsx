...
export default function CategoriesScreen() {
  ...
  const handleDelete = (cat: Category) => {
    Alert.alert(t('deleteCategory'), t('confirmDeleteCategory'), [
      { text: t('cancel'), style: 'cancel' },
      { text: t('delete'), style: 'destructive', onPress: async () => {
        try { await categoriesApi.delete(cat.id); removeCategory(cat.id); } catch (e) { Alert.alert(t('error'), t('failedToDelete')); }
      }},
    ]);
  };
